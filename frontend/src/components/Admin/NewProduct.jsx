// frontend/src/components/Admin/NewProduct.jsx
  ...
  const handleLogoChange = (e) => {
    ...
    reader.onload = () => {
      if (reader.readyState === 2) {
        ...
        setLogo(reader.result); // dataURL base64
      }
    };
...
const handleProductImageChange = (e) => {
    ...
    files.forEach((file, index) => {
        ...
        reader.onload = () => {
            if (reader.readyState === 2) {
                ...
                // 🟢 Nếu Base64 thiếu header MIME → tự chèn
                if (!img64.startsWith("data:image")) {
                    img64 = `data:image/jpeg;base64,${img64}`;
                }

                setImagesPreview(old => [...old, img64]);
                setImages(old => [...old, img64]);
            }
        };
  ...
  const newProductSubmitHandler = (e) => {
    ...
    formData.set("logo", logo); // dataURL, backend sẽ upload
